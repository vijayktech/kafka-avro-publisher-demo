 ...
 */
package com.techgeek.kafka.avroschema.schema.generated;
...
public class StockHistory extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = -6286767577016530161L;
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"StockHistory\",\"namespace\":\"com.techgeek.kafka.avroschema.schema.generated\",\"fields\":[{\"name\":\"tradeId\",\"type\":\"int\",\"default\":-1},{\"name\":\"tradeQuantity\",\"type\":\"int\",\"default\":-1},{\"name\":\"tradeMarket\",\"type\":[\"null\",\"string\"],\"default\":null},{\"name\":\"stockName\",\"type\":[\"null\",\"string\"],\"default\":null},{\"name\":\"tradeType\",\"type\":[\"null\",\"string\"],\"default\":null},{\"name\":\"price\",\"type\":\"float\",\"default\":-100.0},{\"name\":\"amount\",\"type\":\"float\",\"default\":-100.0}]}");
   ...
   */
  public static com.techgeek.kafka.avroschema.schema.generated.StockHistory.Builder newBuilder() {
    return new com.techgeek.kafka.avroschema.schema.generated.StockHistory.Builder();
  }
   ...
   * @return A new StockHistory RecordBuilder
   */
  public static com.techgeek.kafka.avroschema.schema.generated.StockHistory.Builder newBuilder(com.techgeek.kafka.avroschema.schema.generated.StockHistory.Builder other) {
    return new com.techgeek.kafka.avroschema.schema.generated.StockHistory.Builder(other);
  }
   ...
   * @return A new StockHistory RecordBuilder
   */
  public static com.techgeek.kafka.avroschema.schema.generated.StockHistory.Builder newBuilder(com.techgeek.kafka.avroschema.schema.generated.StockHistory other) {
    return new com.techgeek.kafka.avroschema.schema.generated.StockHistory.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<StockHistory>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(com.techgeek.kafka.avroschema.schema.generated.StockHistory.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(com.techgeek.kafka.avroschema.schema.generated.StockHistory other) {
            super(SCHEMA$);
      if (isValidValue(fields()[0], other.tradeId)) {
        this.tradeId = data().deepCopy(fields()[0].schema(), other.tradeId);
        fieldSetFlags()[0] = true;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.techgeek.kafka.avroschema.schema.generated.StockHistory.Builder setTradeId(int value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.techgeek.kafka.avroschema.schema.generated.StockHistory.Builder clearTradeId() {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.techgeek.kafka.avroschema.schema.generated.StockHistory.Builder setTradeQuantity(int value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.techgeek.kafka.avroschema.schema.generated.StockHistory.Builder clearTradeQuantity() {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.techgeek.kafka.avroschema.schema.generated.StockHistory.Builder setTradeMarket(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.techgeek.kafka.avroschema.schema.generated.StockHistory.Builder clearTradeMarket() {
      tradeMarket = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.techgeek.kafka.avroschema.schema.generated.StockHistory.Builder setStockName(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.techgeek.kafka.avroschema.schema.generated.StockHistory.Builder clearStockName() {
      stockName = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.techgeek.kafka.avroschema.schema.generated.StockHistory.Builder setTradeType(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.techgeek.kafka.avroschema.schema.generated.StockHistory.Builder clearTradeType() {
      tradeType = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.techgeek.kafka.avroschema.schema.generated.StockHistory.Builder setPrice(float value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.techgeek.kafka.avroschema.schema.generated.StockHistory.Builder clearPrice() {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.techgeek.kafka.avroschema.schema.generated.StockHistory.Builder setAmount(float value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.techgeek.kafka.avroschema.schema.generated.StockHistory.Builder clearAmount() {
